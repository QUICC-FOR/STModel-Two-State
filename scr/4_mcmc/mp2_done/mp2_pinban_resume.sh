...
$BIN -r $DIR/res/mcmc/"$sp"/0_ch1/resumeData.txt -t $DIR/dat/mcmc/"$sp"_mcmcDat.txt -i "$ni" 2>$DIR/log/mcmc_log_"$sp"_0_ch1.txt &
$BIN -r $DIR/res/mcmc/"$sp"/0_ch2/resumeData.txt -t $DIR/dat/mcmc/"$sp"_mcmcDat.txt -i "$ni" 2>$DIR/log/mcmc_log_"$sp"_0_ch2.txt &
$BIN -r $DIR/res/mcmc/"$sp"/0_ch3/resumeData.txt -t $DIR/dat/mcmc/"$sp"_mcmcDat.txt -i "$ni" 2>$DIR/log/mcmc_log_"$sp"_0_ch3.txt &
