...
$BIN -d -p $DIR/dat/mcmc/"$sp"_mcmcInit1.txt -t $DIR/dat/mcmc/"$sp"_mcmcDat.txt -i "$ni" -c 24 -l 5 -v 2 -o $DIR/res/mcmc/"$sp"/0_ch1  2>$DIR/log/mcmc_log_"$sp"_0_ch1.txt &
...
$BIN -d -p $DIR/dat/mcmc/"$sp"_mcmcInit3.txt -t $DIR/dat/mcmc/"$sp"_mcmcDat.txt -i "$ni" -c 24 -l 5 -v 2 -o $DIR/res/mcmc/"$sp"/0_ch3  2>$DIR/log/mcmc_log_"$sp"_0_ch3.txt &
